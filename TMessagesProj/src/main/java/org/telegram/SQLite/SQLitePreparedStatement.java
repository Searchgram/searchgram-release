...
public class SQLitePreparedStatement {
    ...
    public SQLiteCursor query(Object... args) throws SQLiteException {
        ...
        if (BuildVars.LOGS_ENABLED)
            FileLog.d(sql(sqliteStatementHandle));
    ...
    public void bindString(int index, @NonNull String value) throws SQLiteException {
        bindString(sqliteStatementHandle, index, value);
    }

    public void bindString(int index, @Nullable String value, boolean emptyIfNull) throws SQLiteException {
        if (value == null)
            value = "";
        bindString(sqliteStatementHandle, index, value);
    }
    ...
    native String sql(long statementHandle) throws SQLiteException;
}
