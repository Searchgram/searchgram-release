...
public class MessageObject {
    ...
    public void setQuery(String query) { // highlight query words
        if (TextUtils.isEmpty(query)) {
            return;
        }
        ArrayList<String> foundWords = new ArrayList<>();
        query = query.trim().toLowerCase();
        String[] queryWord = SPLIT.split(query);
        ...
        if (!TextUtils.isEmpty(messageOwner.message)) {
            ...
            String[] words = SPLIT.split(message);
        ...
        if (getDocument() != null) {
            ...
            String[] words = SPLIT.split(fileName);
            searchForWords.addAll(Arrays.asList(words));
        }
        ...
        if (messageOwner.media instanceof TLRPC.TL_messageMediaWebPage && messageOwner.media.webpage instanceof TLRPC.TL_webPage) {
            ...
            if (title != null) {
                ...
                String[] words = SPLIT.split(title);
                searchForWords.addAll(Arrays.asList(words));
            }
        }
        ...
        if (musicAuthor != null) {
            ...
            String[] words = SPLIT.split(musicAuthor);
            searchForWords.addAll(Arrays.asList(words));
        }
